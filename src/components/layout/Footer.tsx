export function Footer() {
  return (
    <footer className="bg-primary text-white py-8 mt-12">
      <div className="max-w-5xl mx-auto px-8 flex flex-col items-center gap-4">
        <span className="font-bold text-2xl tracking-wide">efood</span>
        <p className="text-sm text-center opacity-90">
          A melhor plataforma de delivery de comida do Brasil
        </p>
